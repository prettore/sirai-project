const translations = {
    pt: {
        ...
        'research-area-1-title': 'Redução de Overhead e Segurança de Rede',
        'research-area-1-1': 'Protocolo OpenFlow leve para redes táticas',
        'research-area-1-2': 'Aprendizado federado para aumentar a segurança de rede',
        'research-area-1-3': 'Simulação de ataques cibernéticos e contramedidas usando Cyber Operations Research Gym (CybORG)',
        'research-area-1-4': 'IoT (Smart Home/Smart Farm/Indústria 4.0/MIoT) - Cibersegurança/Automação',
        'research-area-2-title': 'Exploração de Mobilidade',
        'research-area-2-1': 'Uso de ferramentas de IA generativa para criar e configurar ambientes de rede',
        'research-area-2-2': 'Otimização de topologia de rede consciente de mobilidade para cenários táticos',
        'research-area-2-3': 'Previsão de comportamento de unidades em cenários táticos usando Deep Learning',
        'research-area-2-4': 'Modelos de mobilidade coordenada para unidades táticas mistas UAV-terrestres',
    ...
    en: {
        ...
        'research-area-1-title': 'Overhead Reduction and Network Security',
        'research-area-1-1': 'Lightweight OpenFlow protocol for tactical networks',
        'research-area-1-2': 'Federated learning to enhance network security',
        'research-area-1-3': 'Simulation of cyber attacks and countermeasures using Cyber Operations Research Gym (CybORG)',
        'research-area-1-4': 'IoT (Smart Home/Smart Farm/Industry 4.0/MIoT) - Cybersecurity/Automation',
        'research-area-2-title': 'Mobility Exploration',
        'research-area-2-1': 'Use of generative AI tools to create and configure network environments',
        'research-area-2-2': 'Mobility-aware network topology optimization for tactical scenarios',
        'research-area-2-3': 'Prediction of unit behavior in tactical scenarios using Deep Learning',
        'research-area-2-4': 'Coordinated mobility models for mixed UAV-ground tactical units',
